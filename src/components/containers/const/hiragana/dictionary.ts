...
export const gojuons: Map<string, KanaSymbol> = new Map<string, KanaSymbol>([
    ...
    [Hiragana.TU, { shiins: ['t', 'ts'], boin: 'u' }],
...
export const dakuons: Map<string, KanaSymbol> = new Map<string, KanaSymbol> ([
    // が行
...
export const handakuons: Map<string, KanaSymbol> = new Map<string, KanaSymbol> ([
    // ぱ行
...
export const kogakis: Map<string, KanaSymbol> = new Map<string, KanaSymbol>([
    // ぁ行
    ...
    // ゎ
    [Hiragana.XYO, { shiins: ['xw', 'lw'], boin: 'o' }],
]);

export const youons: Map<string, KanaSymbol> = new Map<string, KanaSymbol>([
    // あ行
    ...
    // しゃ行
    [Hiragana.SHA, { shiins: ['sh', 'sy'], boin: 'a', origin: gojuons.get(Hiragana.SI), kogaki: kogakis.get(Hiragana.XYA) }],
    ...
    [Hiragana.CYI, { shiins: ['ch', 'ty'], boin: 'i', origin: gojuons.get(Hiragana.TI), kogaki: kogakis.get(Hiragana.XI) }],
    [Hiragana.CHU, { shiins: ['ch', 'ty'], boin: 'u', origin: gojuons.get(Hiragana.TI), kogaki: kogakis.get(Hiragana.XYU) }],
    [Hiragana.CHE, { shiins: ['ch', 'ty'], boin: 'e', origin: gojuons.get(Hiragana.TI), kogaki: kogakis.get(Hiragana.XE) }],
...
export const HiraganaDictionary: Map<string, KanaSymbol> = new Map<string, KanaSymbol>([...gojuons, ...dakuons, ...handakuons, ...kogakis, ...youons]);